...
class SaveLoadTestCases(unittest.TestCase):
    ...
    def setUp(self):
        ...
        s1 = scan.Scan(data, timestamps, pointing, flags, enviro_ambient, enviro_wind, 'test', 'generated')
        ...
        pm = np.ones(20)
        self.d = dataset.DataSet('', [cs1, cs2], 'counts', corrconf, 'Test, 0, 0, 0, 15.0', nd_data, pm)
