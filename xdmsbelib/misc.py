...
## Calculate and return calibrator source power flux density.
# Calculates flux density of a known source, via a lookup table and interpolation function. If the
# source is not in the lookup table or the frequency is outside the range covered in the table, a NaN
# is returned. The special source 'None' returns a flux density of 0.0, which represents no source.
#
# References: 
# [1] M. Ott et al, "An updated list of radio flux density calibrators", 
...
#                      Name                                 Fmin     Fmax      a       b       c
    calSources = {'3C48'.lower():                        [ 1408.0, 23780.0, 2.465, -0.004, -0.1251],
                  '0134+329'.lower():                    [ 1408.0, 23780.0, 2.465, -0.004, -0.1251],
                  '0134+329 3C48'.lower():               [ 1408.0, 23780.0, 2.465, -0.004, -0.1251],
                  
                  '3C123'.lower():                       [ 1408.0, 23780.0, 2.525,  0.246, -0.1638],
                  '0433+296'.lower():                    [ 1408.0, 23780.0, 2.525,  0.246, -0.1638],
                  '0433+296 3C123'.lower():              [ 1408.0, 23780.0, 2.525,  0.246, -0.1638],
                  
                  '3C147'.lower():                       [ 1408.0, 23780.0, 2.806, -0.140, -0.1031],
                  '0538+498'.lower():                    [ 1408.0, 23780.0, 2.806, -0.140, -0.1031],
                  '0538+498 3C147'.lower():              [ 1408.0, 23780.0, 2.806, -0.140, -0.1031],
                  
                  '3C161'.lower():                       [ 1408.0, 10550.0, 1.250,  0.726, -0.2286],
                  '0624-058'.lower():                    [ 1408.0, 10550.0, 1.250,  0.726, -0.2286],
                  '0624-058 3C161'.lower():              [ 1408.0, 10550.0, 1.250,  0.726, -0.2286],
                  
                  'Hydra A'.lower():                     [ 1408.0, 10550.0, 4.729, -1.025,  0.0130],
                  '3C218'.lower():                       [ 1408.0, 10550.0, 4.729, -1.025,  0.0130],
                  '0915-119'.lower():                    [ 1408.0, 10550.0, 4.729, -1.025,  0.0130],
                  '0915-119 3C218'.lower():              [ 1408.0, 10550.0, 4.729, -1.025,  0.0130],
                  '0915-119 3C218 Hydra A'.lower():      [ 1408.0, 10550.0, 4.729, -1.025,  0.0130],
                  
                  '3C227'.lower():                       [ 1408.0,  4750.0, 6.757, -2.801,  0.2969],
                  '0945+077'.lower():                    [ 1408.0,  4750.0, 6.757, -2.801,  0.2969],
                  '0945+077 3C227'.lower():              [ 1408.0,  4750.0, 6.757, -2.801,  0.2969],
                  
                  '3C249.1'.lower():                     [ 1408.0,  4750.0, 2.537, -0.565, -0.0404],
                  '1100+772'.lower():                    [ 1408.0,  4750.0, 2.537, -0.565, -0.0404],
                  '1100+772 3C249.1'.lower():            [ 1408.0,  4750.0, 2.537, -0.565, -0.0404],
                  
                  'VirA'.lower():                        [ 1408.0, 10550.0, 4.484, -0.603, -0.0280],
                  'Virgo A'.lower():                     [ 1408.0, 10550.0, 4.484, -0.603, -0.0280],
                  '3C274'.lower():                       [ 1408.0, 10550.0, 4.484, -0.603, -0.0280],
                  '1228+127'.lower():                    [ 1408.0, 10550.0, 4.484, -0.603, -0.0280],
                  '1228+127 3C274'.lower():              [ 1408.0, 10550.0, 4.484, -0.603, -0.0280],
                  '1228+127 3C274 Virgo A'.lower():      [ 1408.0, 10550.0, 4.484, -0.603, -0.0280],
                  
                  '3C286'.lower():                       [ 1408.0, 43200.0, 0.956,  0.584, -0.1644],
                  '1328+307'.lower():                    [ 1408.0, 43200.0, 0.956,  0.584, -0.1644],
                  '1328+307 3C286'.lower():              [ 1408.0, 43200.0, 0.956,  0.584, -0.1644],
                  
                  '3C295'.lower():                       [ 1408.0, 32000.0, 1.490,  0.756, -0.2545],
                  '1409+524'.lower():                    [ 1408.0, 32000.0, 1.490,  0.756, -0.2545],
                  '1409+524 3C295'.lower():              [ 1408.0, 32000.0, 1.490,  0.756, -0.2545],
                  
                  '3C309.1'.lower():                     [ 1408.0, 32000.0, 2.617, -0.437, -0.0373],
                  '1458+718'.lower():                    [ 1408.0, 32000.0, 2.617, -0.437, -0.0373],
                  '1458+718 3C309.1'.lower():            [ 1408.0, 32000.0, 2.617, -0.437, -0.0373],
                  
                  'Hercules A'.lower():                  [ 1408.0, 10550.0, 3.852, -0.361, -0.1053],
                  '3C348'.lower():                       [ 1408.0, 10550.0, 3.852, -0.361, -0.1053],
                  '1648+051'.lower():                    [ 1408.0, 10550.0, 3.852, -0.361, -0.1053],
                  '1648+051 3C348'.lower():              [ 1408.0, 10550.0, 3.852, -0.361, -0.1053],
                  '1648+051 3C348 Hercules A'.lower():   [ 1408.0, 10550.0, 3.852, -0.361, -0.1053],
                  
                  '3C353'.lower():                       [ 1408.0, 10550.0, 3.148, -0.157, -0.0911],
                  '1717-009'.lower():                    [ 1408.0, 10550.0, 3.148, -0.157, -0.0911],
                  '1717-009 3C353'.lower():              [ 1408.0, 10550.0, 3.148, -0.157, -0.0911],
                  
                  'CygA'.lower():                        [ 4750.0, 10550.0, 8.360, -1.565,  0.0000],
                  'Cygnus A'.lower():                    [ 4750.0, 10550.0, 8.360, -1.565,  0.0000],
                  '3C405'.lower():                       [ 4750.0, 10550.0, 8.360, -1.565,  0.0000],
                  '1957+406'.lower():                    [ 4750.0, 10550.0, 8.360, -1.565,  0.0000],
                  '1957+406 3C405'.lower():              [ 4750.0, 10550.0, 8.360, -1.565,  0.0000],
                  '1957+406 CygA'.lower():               [ 4750.0, 10550.0, 8.360, -1.565,  0.0000],
                  '1957+406 3C405 Cygnus A'.lower():     [ 4750.0, 10550.0, 8.360, -1.565,  0.0000],
                  
                  'NGC7027'.lower():                     [10550.0, 43200.0, 1.322, -0.134,  0.0000],
                  '2105+420'.lower():                    [10550.0, 43200.0, 1.322, -0.134,  0.0000],
                  '2105+420 NGC7027'.lower():            [10550.0, 43200.0, 1.322, -0.134,  0.0000]
                 }
    
    calNameLowcase = calName.lower()
    
    # Special source that is absent
    if (calNameLowcase == 'none'):
        return 0.0
    
    # Test if specified calibrator is in table
    if calNameLowcase not in calSources:
        logger.warning("Warning: Calibrator '" + calName + "' does not exist in lookup table!")
        return np.nan
    
    # Test if specified frequency is within range
    if ((freq < calSources[calNameLowcase][0]) or (freq > calSources[calNameLowcase][1])):
        logger.warning("Warning: Specified frequency (" + str(freq) + " MHz) is out of range [" + \
                       calSources[calNameLowcase][0] + "," + calSources[calNameLowcase][1] + "]!")
        return np.nan
    
    # Calculate flux density
    return pow(10.0, calSources[calNameLowcase][2] + calSources[calNameLowcase][3] * np.log10(freq) + \
