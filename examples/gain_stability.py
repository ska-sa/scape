...
# Gains and phase as a function of temperature
plt.figure(3)
plt.clf()
ax1 = plt.subplot(311)
plt.plot(temperature, gain_yy_band, 'o')
plt.ylim(gain_yy_mid - 0.5 * gain_range, gain_yy_mid + 0.5 * gain_range)
plt.xticks([])
plt.ylabel('Gain (linear)')
plt.title('Y (H) power gain averaged over band')
ax2 = plt.subplot(312)
plt.plot(temperature, gain_xx_band, 'o')
plt.ylim(gain_xx_mid - 0.5 * gain_range, gain_xx_mid + 0.5 * gain_range)
plt.xticks([])
plt.ylabel('Gain (linear)')
plt.title('X (V) power gain averaged over band')
ax3 = plt.subplot(313)
plt.plot(temperature, phase_yx_band, 'o')
plt.ylim(phase_yx_range)
plt.xlabel('Ambient temperature (deg C)')
plt.ylabel('Phase (deg)')
plt.title('Phase of Y relative to X averaged over band')
plt.savefig('gain_stability_temp.png')
